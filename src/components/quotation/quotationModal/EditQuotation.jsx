...
const EditQuotation = ({ open, onClose, initialData }) => {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setEntityId(initialData.entityName || ""); // Mock prefill
      
      // Mock prefilled line items
      setLineItems([{ id: Date.now(), name: "Mock Product/Service", qty: 1, rate: initialData.amount || 0, unit: "inch", taxPercent: "" }]);
    }
  }, [initialData]);
        ...
        <form onSubmit={handleSubmit} className="flex h-full min-h-0 flex-col">
          <div className="shrink-0 border-b border-gray-200 px-6 py-4 flex items-center justify-between bg-gray-50/50">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Update estimate details.</p>
            </div>
