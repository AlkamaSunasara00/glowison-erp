  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        total: String(initialData.total || '').replace(/[^0-9]/g, ''),
        tax: initialData.tax || "",
      ...
      >
        <form onSubmit={handleSubmit} className="flex h-full min-h-0 flex-col">
          <div className="shrink-0 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
            <div>
              <h2 className="text-base font-semibold text-gray-900">Edit Purchase</h2>
              <p className="mt-1 text-sm text-gray-500">Update purchase order details.</p>
            </div>
